...
# Take user input
diff = float(input('What diffusivity? (in mm^2/s) '))
Co = float(input('What surface concentration? '))


T = 3480.0			# Final Time
num_steps = 300		# number of time steps
dt = T / num_steps	# time step size
#diff = 4E-6		# Diffusivity (um^2/s)

# Create mesh and define function space
mesh = IntervalMesh(1000, 0, 2)
...
u_D = Expression('Coo * (1 - exp(-0.49 * (t/60)))', degree=2, t=0, Coo=Co) # POSSIBLE ISSUE IN DEGREE
...
#call(["ls"])
vtkfile = File('data1D_ER/solution.pvd')
