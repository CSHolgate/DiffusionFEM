...
solutionpvd = PVDReader(FileName='/Users/Collin/Fenics/Diffusion/NonlinearD/1D/dataDiffFConc/solution.pvd')
...
solutionpvdDisplay.ScalarOpacityUnitDistance = 0.29876031643714435
...
renderView1.CameraPosition = [1.0, 10000.0, 0.0]
...
# save data
SaveData('/Users/Collin/Fenics/Diffusion/NonlinearD/1D/dataDiffFConc/fenics.csv', proxy=solutionpvd)
